...
import { NeuralBrainVisual } from "@/components/NeuralBrainVisual";
              ...
              return (
                <Reveal key={c.label} variant="scale" delay={i * 90} className="h-full">
                  <Tilt
                    ...
                    max={7}
                    lift={14}
                    className="section-card group flex h-full flex-col gap-4 rounded-2xl border border-border/70 bg-card/80 p-6 hover:bg-card"
                  >
