  ...
  return (
    <main id="top" className="overflow-x-hidden">
      ...
      <section id="contact" className="border-t border-border bg-background px-6 py-28 sm:px-10 lg:px-14">
        ...
        <div className="scene-3d mt-12 grid gap-px overflow-hidden rounded-2xl bg-border sm:grid-cols-2 lg:grid-cols-4">
          {[
            {
              label: "Email",
            ...
            {
              label: "Instagram",
              value: "instagram.com/karthikeyan.y",
              href: "https://instagram.com/karthikeyan.y",
              icon: IconInstagram,
            },
          ].map((c, i) => {
            const Icon = c.icon;
